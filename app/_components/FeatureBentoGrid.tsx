    ...
    >
      ...
      >
        ...
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          AI instantly evaluates patient symptoms.
        </p>
      ...
      >
        ...
        />
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          Medical notes from voice conversations.
        </p>
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
            Automate patient appointments and follow-ups efficiently.
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">24/7 medical assistance</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 shrink-0" />
      </motion.div>
    </motion.div>
  );
...
const items = [
  ...
  {
    title: "Patient Interaction Insights",
    description: (
      <span className="text-sm">
              Analyze patient conversations in real time to detect urgency, mood, and
      care needs for better clinical decisions.
      </span>
    ),
    header: <SkeletonFour />,
